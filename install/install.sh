...
sudo cp --verbose /home/pi/moonboard/ble/com.moonboard.conf /etc/dbus-1/system.d
sudo cp --verbose /home/pi/moonboard/ble/com.moonboard.service /lib/systemd/system/com.moonboard.service
...
sudo cp --verbose /home/pi/moonboard/services/moonboard.service /lib/systemd/system/moonboard.service
